...
stMovimientos eliminaMovimiento(char nombreArchivo[],int idMovimiento, int idCuenta);
stMovimientos altaMovimiento(char nombreArchivo[],int idMovimiento, int idCuenta);
